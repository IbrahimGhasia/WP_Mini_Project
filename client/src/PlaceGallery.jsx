				...
				<div className="bg-black p-8 grid gap-4">
					<div className="">
						...
						<button
							...
							className="fixed right-12 top-6 flex gap-1 py-2 px-4 rounded-2xl shadow-md shadow-black bg-white text-black"
						>
							<svg
					...
					{place.photos?.[0] && (
						<div>
							<img
								...
								className="aspect-sqaure object-cover w-full h-full cursor-pointer"
